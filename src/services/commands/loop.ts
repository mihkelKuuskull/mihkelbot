    ...
    execute: async ({ inter }) => {
        ...
        switch (inter.options._hoistedOptions.map((x) => x.value).toString()) {
            case 'enable_loop_queue': {
                ...
                const success = Boolean(queue.setRepeatMode(QueueRepeatMode.QUEUE));
            ...
            case 'disable_loop': {
                ...
                const success = Boolean(queue.setRepeatMode(QueueRepeatMode.OFF));
            ...
            case 'enable_loop_song': {
                ...
                const success = Boolean(queue.setRepeatMode(QueueRepeatMode.TRACK));
            ...
            case 'enable_autoplay': {
                ...
                const success = Boolean(queue.setRepeatMode(QueueRepeatMode.AUTOPLAY));
